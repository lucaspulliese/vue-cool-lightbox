    ...
    <div class="cool-lightbox"
      ...
      <div
        ...
        <div class="cool-lightbox__navigation">
          <button type="button" class="cool-lightbox-button cool-lightbox-button--prev" :title="tranlations.previous" :class="buttonsClasses" v-show="(hasPreviousButton || loopData) && items.length > 1" @click="onPrevClick">
          ...
          <button type="button" class="cool-lightbox-button cool-lightbox-button--next" :title="tranlations.next" :class="buttonsClasses" v-show="(hasNextButton || loopData) && items.length > 1" @click="onNextClick(false)">
            <slot name="icon-next">
              <div class="cool-lightbox-button__icon">
        ...
        <div class="cool-lightbox-toolbar" :class="buttonsClasses">
          ...
          <button type="button" v-if="this.slideshow && items.length > 1" :title="tranlations.playSlideShow" class="cool-lightbox-toolbar__btn" @click="togglePlaySlideshow">
          ...
          <button type="button" @click="showThumbs = !showThumbs" :title="tranlations.showThumbNails" v-if="items.length > 1 && gallery" class="cool-lightbox-toolbar__btn">
          ...
          <button type="button" v-if="fullScreen" @click="toggleFullScreenMode" class="cool-lightbox-toolbar__btn" :title="tranlations.fullScreen">
          ...
          <button type="button" v-if="showCloseButton" class="cool-lightbox-toolbar__btn" :title="tranlations.close" @click="close">
            <slot name="close">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
